...
class BaseAvatar extends StatelessWidget {
  const BaseAvatar({super.key, required this.url, required this.size, this.padding, this.onTap, this.border});
      ...
      child: Container(
        ...
        child: url.isNotEmpty
            ...
            : Padding(
                ...
                child: SvgPicture.asset(MediaUtils.icAvatarDefault, fit: BoxFit.cover),
              ),
      ),
    );
  }
