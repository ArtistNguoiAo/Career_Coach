...
class _ActivityScreenState extends State<ActivityScreen> {
  final List<TextEditingController> _listOrganizationController = [];
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ActivityCubit()..init(userResumeId: widget.userResumeId),
      child: Scaffold(
        appBar: AppBar(
          leading: InkWell(
            onTap: () {
    ...
    return BlocConsumer<ActivityCubit, ActivityState>(
      listener: (context, state) {
        ...
        for (var it in state.listActivity) {
          _listOrganizationController.add(TextEditingController(text: it.organization));
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  BaseContent(
                    controller: _listOrganizationController[index],
                    isRequired: true,
