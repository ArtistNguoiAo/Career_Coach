...
import 'package:career_coach/presentation/screen/section_resume/activity/cubit/activity_cubit.dart';
...
class ActivityScreen extends StatefulWidget {
  const ActivityScreen({super.key, required this.userResumeId});
  ...
  Widget _listView() {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return InkWell(
          onTap: () {
            AutoRouter.of(context).push(ActivityDetailRoute());
          },
          child: Container(
            ...
            child: Row(
              children: [
                Icon(size: 20, FontAwesomeIcons.diceD6, color: context.theme.darkGreyColor),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text("Volunteer", style: TextStyleUtils.normal(color: context.theme.textColor, fontSize: 16)),
                      SizedBox(height: 4),
                      Text(
                        "Jan 2020 - Dec 2023",
                ...
                const SizedBox(width: 16),
                Icon(size: 20, FontAwesomeIcons.trash, color: context.theme.darkGreyColor),
              ],
            ),
          ),
        );
