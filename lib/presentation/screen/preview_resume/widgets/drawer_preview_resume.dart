                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        ...
                        else if(sections[index] == TypeResumeSectionEnum.PROJECT) {
                          AutoRouter.of(
                            context,
                        ...
                        else if(sections[index] == TypeResumeSectionEnum.OTHER_INFORMATION) {
                          AutoRouter.of(
                            context,
                          ).push(OtherInformationRoute(userResumeId: widget.userResumeEntity?.id ?? 0));
                        }
                        else if(sections[index] == TypeResumeSectionEnum.AVATAR) {
                          AutoRouter.of(
                            context,
                          ).push(AvatarRoute(userResumeId: widget.userResumeEntity?.id ?? 0));
                        }
                      },
                      child: Container(
                        padding: const EdgeInsets.all(16),
