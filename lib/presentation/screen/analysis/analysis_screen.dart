        ...
        body: BlocBuilder<AnalysisCubit, AnalysisState>(
          builder: (context, state) {
            return Container(
              ...
              child: state.analysisEntity?.analysisStatus == TypeAnalysisStatusEnum.PROCESSING
                  ? Center(
                      child: Container(
                        padding: const EdgeInsets.all(16),
                        margin: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          color: context.theme.primaryColor.withAlpha((0.1 * 255).toInt()),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              state.analysisEntity?.detailedFeedback ?? '',
                            ...
                            InkWell(
                              onTap: () {
                                context.read<AnalysisCubit>().init(widget.sessionId);
                              },
                              child: Container(
                                ...
                                child: Text(
                                  context.language.refresh,
                                  style: TextStyleUtils.normal(color: Colors.white, fontSize: 16),
                                ),
                              ),
                            ),
                          ],
                  ...
                  : state.analysisEntity?.analysisStatus == TypeAnalysisStatusEnum.COMPLETED
                        ...
                        children: [
                                        ...
                                        SleekCircularSlider(
                                          ...
                                          innerWidget: (value) {
                                            return Center(
                                              child: Text(
                                                '${value.toInt()}',
                                                style: TextStyleUtils.bold(color: Color(0xFFF6A881), fontSize: 32),
                                              ),
                                            );
                                          },
                              ...
                              BarChartData(
                                ...
                                gridData: FlGridData(
                                  ...
                                  getDrawingHorizontalLine: (value) =>
                                      FlLine(color: context.theme.primaryDarkColor, strokeWidth: 1),
                                ),
                                  ...
                                  leftTitles: AxisTitles(
                                    sideTitles: SideTitles(
                                      ...
                                      getTitlesWidget: (value, _) => Text(
                                        ...
                                        style: TextStyleUtils.normal(color: context.theme.textColor, fontSize: 10),
                                      ),
                                    ),
                                  ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '${context.language.strengths}: ',
                                  style: TextStyleUtils.bold(color: context.theme.primaryDarkColor, fontSize: 16),
                                ),
                                BaseMarkdown(
                                  data: state.analysisEntity?.strengths ?? '',
                                ),
                                SizedBox(height: 12),
                                Text(
                                  '${context.language.weaknesses}: ',
                                  style: TextStyleUtils.bold(color: context.theme.primaryDarkColor, fontSize: 16),
                                ),
                                BaseMarkdown(
                                  data: state.analysisEntity?.weaknesses ?? '',
                                ),
                                SizedBox(height: 12),
                                Text(
                                  '${context.language.detailedFeedback}: ',
                                  style: TextStyleUtils.bold(color: context.theme.primaryDarkColor, fontSize: 16),
                                ),
                                BaseMarkdown(
                                  data: state.analysisEntity?.detailedFeedback ?? '',
                                ),
                              ],
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '${context.language.recommendations}: ',
                                  style: TextStyleUtils.bold(color: context.theme.primaryDarkColor, fontSize: 16),
                                ),
                                BaseMarkdown(
                                  data: state.analysisEntity?.recommendations ?? '',
                                ),
                              ],
                            ),
                          ),
