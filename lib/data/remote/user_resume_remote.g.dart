...
class _UserResumeRemote implements UserResumeRemote {
  ...
  @override
  Future<HttpResponse<List<int>>> getPdf({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ApiResponse<UserResumeModel>> createNewUserResumeWithAI({
    required UserResumeWithAiRequestBody userResumeWithAiRequestBody,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(userResumeWithAiRequestBody.toJson());
    final _options = _setStreamType<ApiResponse<UserResumeModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
